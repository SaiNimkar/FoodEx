...
import com.sai.gofoodie.ui.adapters.FoodListAdapter;
import com.sai.gofoodie.util.ObservableObject;
import com.sai.gofoodie.viewmodel.FoodViewModel;
...
public class MainActivity extends AppCompatActivity implements java.util.Observer, PopupMenu.OnMenuItemClickListener{
    ...
    private void subscribeToFoodObserver() {
        if(!foodViewModel.getFoodDetailsMutableLiveData().hasObservers()) {
            foodViewModel.getFoodDetailsMutableLiveData().observe(MainActivity.this, foodMenuObserver);
        }

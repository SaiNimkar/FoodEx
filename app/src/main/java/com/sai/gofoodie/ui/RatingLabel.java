...
public class RatingLabel  extends AppCompatTextView {
    ...
    public RatingLabel(Context context) {
        super(context);
        setUpRateStar();
        drawRating();
    }

    public RatingLabel(Context context, AttributeSet attrs) {
        super(context, attrs);
        setUpRateStar();
    ...
    public RatingLabel(Context context, AttributeSet attrs, int defStyleAttr) {
